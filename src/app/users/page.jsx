            ...
            {users.map((user) => (
                <div key={user.id} className="mb-4">
                    ...
                    >
                        ...
                        />
                        <div>
                        <h1 className="font-bold flex"><FaRegUserCircle className='mr-2 mt-1'/>{user.profile.username}</h1>
                        <h2 className='text-slate-600 pb-2 flex'><PiOfficeChairFill className='mr-2 mt-1'/>{user.jobTitle}</h2>
                        </div>
                    </div>
                    <hr />
                    <hr />
